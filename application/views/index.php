  ...
  <div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="assets/index.html">Koplak Food</a>
      </div>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="assets/produk.html">PRODUK</a></li>
              <li><a href="assets/transaksi.html">TRANSAKSI</a></li>
              <li><a href="assets/keranjang.html">KERANJANG</a></li>
              <li><a href="assets/profil.html">YOUR PROFIL</a></li>
            </ul>
          </li>
        </ul>
      </div>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <img src="assets/img/1.jpeg" class="center" alt="">
            </div>
            <div class="item">
              <img src="assets/img/2.jpeg" class="center" alt="">
            </div>
            <div class="item">
              <img src="assets/img/3.jpeg" class="center" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="he-wrap tpl6">
            ...
            <div class="he-view">
              <div class="bg a0" data-animate="fadeIn">
                ...
                <a href="assets/produk.html" class="dmbutton a2" data-animate="fadeInUp"><i class="fa fa-link"></i></a>
              </div>
              <!-- he bg -->
            </div>
            <!-- he view -->
  ...
  <div class="container mtb">
    <div class="row">
      <div class="col-lg-4 col-lg-offset-1">
        ...
        <p><br/><a href="assets/about.html" class="btn btn-theme">More Info</a></p>
      </div>
      ...
      <div class="col-lg-3">
        <h4>Latest Posts</h4>
        <div class="hline"></div>
        <p><a href="assets/transaksi.html">Our new site is live now.</a></p>
        <p><a href="assets/transaksi.html">Retina ready is not an option.</a></p>
        <p><a href="assets/transaksi.html">Bootstrap 3 framework is the best.</a></p>
        <p><a href="assets/transaksi.html">You need this theme, buy it now.</a></p>
        <p><a href="assets/transaksi.html">This theme is what you need.</a></p>
      </div>
